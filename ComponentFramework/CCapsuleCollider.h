...
public:
	CCapsuleCollider(Ref<Component> parent_, float radius_ = 0.5f, float height_ = 2.0f, Vec3 offset_ = Vec3()) :
	...
	virtual MeshCollisionInfo IntersectingMesh(const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices) const override;
